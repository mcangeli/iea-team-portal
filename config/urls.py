...
from portal.auth_views import ArenaLineLoginView, mfa_login_challenge

urlpatterns = [
    path("admin/", admin.site.urls),
    path("accounts/login/", ArenaLineLoginView.as_view(), name="login"),
    path("accounts/mfa/", mfa_login_challenge, name="mfa_login_challenge"),
    path("accounts/", include("django.contrib.auth.urls")),
    path("", include("portal.public_urls")),
    path("", include("portal.public_site_admin_urls")),
