...
urlpatterns = [
    ...
    path("people/<int:pk>/iea/", person_iea_membership_edit, name="person_iea_membership_edit"),
    path("people/<int:pk>/iea/<int:season_pk>/", person_iea_membership_edit, name="person_iea_membership_edit_season"),
