...
class V320PeopleDirectoryTests(TestCase):
    def setUp(self):
        ...
        self._configure_profile(self.member, self.team, UserProfile.Role.RIDER)

        self.other_user = User.objects.create_user(
            username="other-v320", password="pass12345", first_name="Other", last_name="User"
        )
        self._configure_profile(self.other_user, self.other_team, UserProfile.Role.ADMIN)
    ...
    def test_other_non_manager_does_not_receive_private_fields(self):
        ...
        self._configure_profile(peer_user, self.team, UserProfile.Role.PARENT)
    ...
    def test_manager_can_create_person_and_attach_same_team_django_account(self):
        ...
        self._configure_profile(unused_user, self.team, UserProfile.Role.PARENT)
