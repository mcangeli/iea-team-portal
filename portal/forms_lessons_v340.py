...
class LessonSeriesForm(forms.ModelForm):
    class Meta:
        model = LessonSeries
        fields = [
            "name", "instructor", "weekday", "starts_at_time", "duration_minutes",
            "default_location", "capacity", "start_date", "end_date", "active", "notes",
        ]
        widgets = {
    ...
    def __init__(self, *args, program, **kwargs):
        ...
        self.fields["weekday"].widget = forms.Select(choices=[
