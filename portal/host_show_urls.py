...
urlpatterns = [
    ...
    path("shows/<int:show_pk>/host/complete/", host_show_views.host_show_mark_complete, name="host_show_mark_complete"),
    path("shows/<int:show_pk>/host/reopen/", host_show_views.host_show_reopen, name="host_show_reopen"),
