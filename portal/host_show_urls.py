...
urlpatterns = [
    ...
    path("shows/<int:show_pk>/host/managers/add/", host_show_views.show_manager_add, name="show_manager_add"),
    path("shows/<int:show_pk>/host/managers/<int:assignment_pk>/remove/", host_show_views.show_manager_remove, name="show_manager_remove"),
