...
urlpatterns=[
 ...
 path("finance/workspace/transactions/<int:pk>/",finance_v350.finance_transaction_detail,name="finance_transaction_detail"),
 path("finance/workspace/budgets/",finance_v350.finance_budgets,name="finance_budgets"),
 path("finance/workspace/budgets/add/",finance_v350.finance_budget_add,name="finance_budget_add"),
 path("finance/workspace/budgets/<int:pk>/",finance_v350.finance_budget_detail,name="finance_budget_detail"),
 path("finance/workspace/budgets/<int:pk>/edit/",finance_v350.finance_budget_edit,name="finance_budget_edit"),
 path("finance/workspace/budgets/<int:pk>/lines/add/",finance_v350.finance_budget_line_add,name="finance_budget_line_add"),
 path("finance/workspace/budgets/<int:pk>/lines/<int:line_id>/edit/",finance_v350.finance_budget_line_edit,name="finance_budget_line_edit"),
 path("finance/workspace/receivables/",finance_v350.finance_receivables,name="finance_receivables"),
 path("finance/workspace/receivables/billing-rules/add/",finance_v350.finance_billing_rule_add,name="finance_billing_rule_add"),
 path("finance/workspace/receivables/monthly-billing/",finance_v350.finance_monthly_billing_run,name="finance_monthly_billing_run"),
 path("finance/workspace/receivables/credit-rules/add/",finance_v350.finance_credit_rule_add,name="finance_credit_rule_add"),
 path("finance/workspace/receivables/credit-rules/<int:pk>/edit/",finance_v350.finance_credit_rule_edit,name="finance_credit_rule_edit"),
 ...
 path("finance/workspace/accounts/<int:pk>/credit-allocations/<int:allocation_id>/unallocate/",finance_v350.finance_credit_unallocate,name="finance_credit_unallocate"),
