...
urlpatterns = [
    ...
    path("facility-spaces/<int:space_pk>/reservations/add/", facility_views.resource_reservation_create, name="resource_reservation_create"),
    path("resource-reservations/<int:pk>/edit/", facility_views.resource_reservation_edit, name="resource_reservation_edit"),
    path("resource-reservations/<int:pk>/cancel/", facility_views.resource_reservation_delete, name="resource_reservation_cancel"),
