...
sudo unzip iea-team-portal-v1.9.4.2.1.1.zip
cd iea-team-portal-v1.9.4.2.1
chmod +x portalctl
```
...
```bash
cd /opt/iea-team-portal/iea-team-portal-v1.9.4.2.1
chmod +x portalctl
./portalctl upgrade
```
